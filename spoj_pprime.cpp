...
ll dis[100001];
ll visited[100001];
ll convert_to_array(ll dig[], ll x)
{
    ll i=3;
    while(x)
    {
...
int main()
{
    ...
    Seive();
       ...
       memset(dis,-1,sizeof(dis));
        ...
        q=y;
        ll i=3;
        convert_to_array(A,x);
        convert_to_array(B,y);
        bfs(x,y);
        dis[y]==-1 ? cout<<"Impossible"<<endl :cout<<dis[y]<<endl;
